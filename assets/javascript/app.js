$(document).ready(function () {
    ...
    var triviaGame = {
        ...
        question1: {
            ...
            correctAnswer: "Bad burns",
            otherAnswers: ["Broken leg", "Puncture wound from a piece of the flying monkey's costume", "Bitten by a dog"],
        ...
        question2: {
            ...
            otherAnswers: ['It was the “most flattering” thing someone could have done.', 'She was outraged and demanded he change the name of the character.', 'It was the “most enduring” thing someone could have done.'],
        ...
        question3: {
            ...
            correctAnswer: "White",
            otherAnswers: ["pink", "green", "yellow"],
            answerInfo: "White - In Baum’s book, the city is white. The inhabitants of the emerald city only see it as green because of special green spectacles the Wizard forces them to wear. ",
...
$("#start-button").on("click", function ()  {
        ...
        $("#question-area").append(triviaGame.question1.question);
      
        $("#a").text(triviaGame.question1.otherAnswers[0]);
     
        $("#b").text(triviaGame.question1.otherAnswers[1]);
     
        $("#c").text(triviaGame.question1.correctAnswer);

        $("#c").addClass("correct");
     
        $("#d").text(triviaGame.question1.otherAnswers[2]);
